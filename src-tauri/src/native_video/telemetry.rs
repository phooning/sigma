...
pub struct TelemetrySnapshot {
    ...
    pub frame_unsubscribed_drops: u64,
    pub broker_send_failures: u64,
    pub broker_backpressure_drops: u64,
    pub broker_stream_frame_replacements: u64,
    pub broker_backpressure_active: bool,
