...
- **Video Controls**: Frame-accurate scrubbing, A/B looping, and dynamic visual resizing and cropping.
- **Local-First Performance**: Leverages Rust-based backend for media handling at desktop V-Sync and low memory footprint.
- **Export Utility**: Basic H.264 export for A/B loops, screenshots, and cropped segments.
- **Workflows, Save/Load:** Config can be saved to preserve layout, so you can load up templates at any time.
...
> _Film edit planning, ML/dataset triage, moodboarding with massive clips, evidence intel boards: just drop a bunch of media down and think about it spatially._

## Tech Stack

- **Frontend**: React TypeScript
- **Backend**: Rust IPC video/image pipeline
...
_Created by [David Pham](https://github.com/phooning/)._
